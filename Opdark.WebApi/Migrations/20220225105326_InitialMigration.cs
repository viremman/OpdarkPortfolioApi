        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumberOfProjectUsedIn = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BiosId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ServicesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BioService", x => new { x.BiosId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_BioService_Bios_BiosId",
                        column: x => x.BiosId,
                        principalTable: "Bios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BioService_Services_ServicesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BioSkill", x => new { x.BiosId, x.SkillsId });
                    table.ForeignKey(
                        name: "FK_BioSkill_Bios_BiosId",
                        column: x => x.BiosId,
                        principalTable: "Bios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BioSkill_Skills_SkillsId",
                        column: x => x.SkillsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BioService_ServicesId",
                table: "BioService",
                column: "ServicesId");

            migrationBuilder.CreateIndex(
                name: "IX_BioSkill_SkillsId",
                table: "BioSkill",
                column: "SkillsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_BioId",
                table: "Contacts",
                column: "BioId");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_BioId",
                table: "Projects",
                column: "BioId");
        }
